...
IMAGE = 'smallthinking/multimodal-judge:runpod-refresh-mse-10ep-20260909'
...
def command(args):
    ...
    base += ['--entrypoint', 'multimodal-judge', args.image]
    if args.action == 'check':
    ...
    return base + ['evaluate', '--checkpoint', f'/app/artifacts/training/{args.run_name}',
                   ...
                   '--wandb-mode', 'online', '--output-dir', f'/app/artifacts/evaluation/{args.run_name}']
...
def main():
    ...
    parser.add_argument('--epochs', type=int, choices=[5, 10], default=10)
    parser.add_argument('--score-only', action='store_true')
    parser.add_argument('--run-name', default='refresh-joint-mse-10ep')
